 ...
 */
namespace WP_Typography\Vendor\Mundschenk;
...
class WP_Requirements
{
    ...
    public function __construct($name, $plugin_path, $textdomain, $requirements)
    {
        ...
        $this->install_requirements = \wp_parse_args($requirements, ['php' => '7.4.0', 'multibyte' => \false, 'utf-8' => \false]);
    }
    /**
    ...
    public function check()
    {
        ...
        if (!$requirements_met && !empty($notice) && \is_admin()) {
            ...
            // phpcs:ignore WordPress.WP.I18n.NonSingularStringLiteralDomain -- this is a library.
            // Add admin notice.
    ...
    public function admin_notices_mbstring_incompatible()
    {
        $this->display_error_notice(
            ...
            \__('https://www.php.net/manual/en/mbstring.installation.php', $this->textdomain)
        );
    }
    /**
    ...
    protected function display_error_notice($format)
    {
        ...
        $args = \func_get_args();
        // phpcs:ignore PHPCompatibility.FunctionUse.ArgumentFunctionsReportCurrentValue.NeedsInspection -- $format is not changed.
